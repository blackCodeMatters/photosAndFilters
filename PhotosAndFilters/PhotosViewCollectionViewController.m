//
//  TWPhotosViewCollectionViewController.m
//  PhotosAndFilters
//
...
@interface PhotosViewCollectionViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@property (strong, nonatomic) NSMutableArray *photos;

@end

@implementation PhotosViewCollectionViewController
